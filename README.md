...
* [Identifiers-java](https://github.com/Identifiers/identifiers-java)
...
|`integer`|`0x2`|[int](https://github.com/msgpack/msgpack/blob/master/spec.md#int-format-family)|`0xa`|`0x12`|
|`float`|`0x3`|[float](https://github.com/msgpack/msgpack/blob/master/spec.md#float-format-family)|`0xb`|`0x13`|
|`long`|`0x4`|[int](https://github.com/msgpack/msgpack/blob/master/spec.md#int-format-family)|`0xc`|`0x14`|
...
|type|code|MsgPack family|
|---|---|---|
|`composite-list`|`0x38`|[array](https://github.com/msgpack/msgpack/blob/master/spec.md#array-format-family)|
|`composite-map`|`0x58`|[map](https://github.com/msgpack/msgpack/blob/master/spec.md#map-format-family)|
...
|`datetime`|`1`|`0x184`|[int](https://github.com/msgpack/msgpack/blob/master/spec.md#int-format-family)|`0x18c`|`0x194`|
|`geo`|`2`|`0x28b`|[fixarray]((https://github.com/msgpack/msgpack/blob/master/spec.md#array-format-family)) size 2 floats|`0x2ab`|`0x2cb`|
...
|type|code|MsgPack family|
|---|---|---|
|`list-of`|`0x20`|[array[semantic]](https://github.com/msgpack/msgpack/blob/master/spec.md#array-format-family)|
|`map-of`|`0x40`|[map[semantic]](https://github.com/msgpack/msgpack/blob/master/spec.md#map-format-family)|

For example, to create the type code for a list of `geo`s, Set the `list-of` flag bit (`0x20`):
